(function (window) {
    ...
    const richText = new PIXI.Text('LPS sample animation', style); richText.x = 20; richText.y = 20;
    const graphics = new PIXI.Graphics();

    function createVisulaiser(){
